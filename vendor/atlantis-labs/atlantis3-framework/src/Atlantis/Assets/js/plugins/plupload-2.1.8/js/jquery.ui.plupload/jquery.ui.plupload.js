			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						'<label class="plupload_header_title">' + _("Select files") + '</label>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="button plupload_button plupload_add">' + _("Add Files") + '</a>&nbsp;' +
							'<a class="button alert plupload_button plupload_start">' + _("Start Upload") + '</a>&nbsp;' +
							'<a class="button warning plupload_button plupload_stop plupload_hidden">'+_("Stop Upload") + '</a>&nbsp;' +
						'</div>' +
...
$.widget("ui.plupload", {
	...
	*/
	notify: function(type, message) {
		var popup = $(
			'<div class="plupload_message callout">' + 
				'<span class="plupload_message_close fa fa-times-circle" title="'+_('Close')+'"></span>' +
				'<p><span class="fa"></span>' + message + '</p>' +
			'</div>'
		);
					
		popup
			.addClass(' ' + (type === 'error' ? 'alert' : 'success'))
			.find('p .fa')
				.addClass('fa-' + (type === 'error' ? 'exclamation-triangle' : 'info-circle'))
				.end()
	...
	_handleFileStatus: function(file) {
		...
		switch (file.status) {
			case plupload.DONE: 
				...
				iconClass = 'plupload_action_icon fa fa-check';
				break;
			
			case plupload.FAILED:
				actionClass = 'ui-state-error plupload_failed';
				iconClass = 'plupload_action_icon fa fa-exclamation';
				break;

			case plupload.QUEUED:
				actionClass = 'plupload_delete';
				iconClass = 'plupload_action_icon fa fa-times';
				break;

			case plupload.UPLOADING:
				actionClass = 'ui-state-highlight plupload_uploading';
				iconClass = 'plupload_action_icon fa fa-spinner fa-spin';
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_delete" id="{id}" style="width:{thumb_width}px;">' +
			...
			'<div class="plupload_file_action">' +
				'<div class="plupload_action_icon fa fa-times"></div>' +
			'</div>' +
