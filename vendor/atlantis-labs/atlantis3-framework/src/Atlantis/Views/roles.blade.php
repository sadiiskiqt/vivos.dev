...
@section('title')
Roles | A3 Administration | {{ config('atlantis.site_name') }}
@stop
      ...
      <div class="columns small-12">
        <ul class="tabs" data-tabs id="example-tabs">
          ...
          <li class="float-right list-filter">
            ...
            <a id="save-close-btn" class="alert button" href="/admin/roles/add">New Role</a>
          </li>	
        </ul>
        <div class="tabs-content" data-tabs-content="example-tabs">
          <div class="tabs-panel is-active" id="panel1">
            {!! DataTable::set(\Atlantis\Controllers\Admin\RolesDataTable::class) !!}
          </div>
