...
class CheckboxDataTable implements \Atlantis\Helpers\Interfaces\DataTableInterface
{
    ...
    {
        return [
            'url' => 'admin/modules/accommodations/bulk-action-checkbox',
            'actions' => [
                [
                    'name' => 'Delete',
                    'key' => 'bulk_delete'
    ...
    {
        $model = DB::table('accommodations_checkbox_category');
        /*
         * SEARCH
         */
        if (isset($request->get('search')['value']) && !empty($request->get('search')['value'])) {
            ...
            $model->orWhere('sCheckboxTitle', 'LIKE', '%' . $search . '%');
        }
    ...
    private function nameTd($obj)
    {
        ...
        return '<span class="tags hidden">tags</span>
                    <a class="item" href="/admin/modules/accommodations/edit-check-box/' . $obj->id . '">' . $obj->sCheckboxTitle . '</a>
                    <span class="actions">
                      <a data-tooltip title="Edit Checkbox" href="/admin/modules/accommodations/edit-check-box/' . $obj->id . '" class="icon icon-Edit top"></a> 
                      <a data-open="deleteMenu' . $obj->id . '" data-tooltip aria-haspopup="true" data-disable-hover="false" tabindex="1" title="Delete Checkbox" class="icon icon-Delete top "></a>
                    </span>' .
            \Atlantis\Helpers\Modal::set('deleteMenu' . $obj->id, 'Delete Checkbox', 'Are you sure you want to delete ' . $obj->sCheckboxTitle, 'Delete', '/admin/modules/accommodations/remove-checkbox/' . $obj->id);
    }
