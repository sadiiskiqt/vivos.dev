...
class DropDownDataTable implements \Atlantis\Helpers\Interfaces\DataTableInterface
{
    ...
    {
        return [
            'url' => 'admin/modules/accommodations/bulk-action-drop-down',
            'actions' => [
                [
                    'name' => 'Delete',
                    'key' => 'bulk_delete'
    ...
    {
        $model = DB::table('accommodations_dropdown_category');
        /*
         * SEARCH
         */
        if (isset($request->get('search')['value']) && !empty($request->get('search')['value'])) {
            ...
            $model->orWhere('sDropDownTitle', 'LIKE', '%' . $search . '%');
        }
    ...
    private function nameTd($obj)
    {
        ...
        return '<span class="tags hidden">tags</span>
                    <a class="item" href="/admin/modules/accommodations/edit-dropdown/' . $obj->id . '">' . $obj->sDropDownTitle . '</a>
                    <span class="actions">
                      <a data-tooltip title="Edit Drop Down" href="/admin/modules/accommodations/edit-dropdown/' . $obj->id . '" class="icon icon-Edit top"></a> 
                      <a data-open="deleteMenu' . $obj->id . '" data-tooltip aria-haspopup="true" data-disable-hover="false" tabindex="1" title="Delete Drop Down" class="icon icon-Delete top "></a>
                    </span>' .
            \Atlantis\Helpers\Modal::set('deleteMenu' . $obj->id, 'Delete Drop Down', 'Are you sure you want to delete ' . $obj->sDropDownTitle, 'Delete', '/admin/modules/accommodations/remove-drop-down/' . $obj->id);
    }
