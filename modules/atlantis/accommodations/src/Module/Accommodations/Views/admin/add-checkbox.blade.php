...
@section('content')
    ...
    <main>
        ...
        <section class="editscreen">
            {!! Form::open(['url' => '/admin/modules/accommodations/add-checkbox', 'data-abide' => '', 'novalidate'=> '']) !!}
            <div class="row">
                <div class="columns">
                    <div class="float-right">
                        <div class="buttons">
                                        ...
                                        <div class="columns medium-8">
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                                    ...
                                                    var fieldHTML = '<div>'
                                                        + '<label for="page_name"> Add Filter Title'
                                                        + '</label>'
                                                        + '<input style="float: right" type="text" name="field_name_checkbox[]" value=""/>'
